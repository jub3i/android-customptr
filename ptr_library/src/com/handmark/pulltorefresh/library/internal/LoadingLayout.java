...
public class LoadingLayout extends FrameLayout {
	...
	//AF-replaced with ImageView
	//private final ProgressBar mHeaderProgress;
	
	//AF-create ImageView & AnimationDrawable
	private final ImageView mshrmCldImage;
	private final AnimationDrawable mshrmCldAnimation;
	...
	public LoadingLayout(Context context, final Mode mode, TypedArray attrs) {
		...
		mshrmCldImage = (ImageView) findViewById(R.id.simple_anim);
		...
		switch (mode) {
			case PULL_UP_TO_REFRESH:
				...
				//AF-setBackGroundResrouce of ImageView 
				mshrmCldImage.setBackgroundResource(R.drawable.mshrm_cld_anim);
				mshrmCldAnimation = (AnimationDrawable) mshrmCldImage.getBackground();
	...
	public void reset() {
		...
		//AF-change the animations visibility to GONE
		mshrmCldImage.setVisibility(View.GONE);
	...
	public void refreshing() {
		...
		//AF-change the animations visibility to VISIBLE and start the animation
		mshrmCldImage.setVisibility(View.VISIBLE);
		mshrmCldAnimation.start();
